...
class _BotCommands:
    def __init__(self):
        ...
        self.VvvidCommand = f'vvvid{CMD_INDEX}'
        ...
        self.WatchCommand = f'undyt{CMD_INDEX}'
        self.ZipWatchCommand = f'undyta{CMD_INDEX}'
        ...
        self.LeechWatchCommand = f'undytaq{CMD_INDEX}'
        self.LeechZipWatchCommand = f'undytaqm{CMD_INDEX}'
